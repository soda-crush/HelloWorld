	...
	<jsp:include page="/WEB-INF/views/standard/header.jsp"/>
 		...
 		<div id=baseBackgroundColor>
            ...
            <div class=container id="projectPage">
				...
				<div class="col-12 d-none d-md-block">
					<div id="pageTitle">
						<table>
							<tr>
								<td colspan="3" style="font-size: 60px; font-weight: 100; vertical-align: text-bottom"><h1>HELL<span style="opacity:0.5">o</span></h1></td>
								<td></td>
			...
			<div class=row>
				<div class="d-md-none">
				<div id="pageTitle">
					<div style="font-size: 60px; font-weight: 100;"><h1>HELL<span style="opacity:0.5">o</span></h1></div>
