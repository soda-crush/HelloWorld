                            ...
                            <div class="card-body">
	                            <div class="col-auto text-left mb-3">
			                    	<div class="btn-group" role="group" aria-label="Basic example">
			                    		...
			                    		<button type="button" class="btn btn-flat btn-xs btn-warning" id="endList">처리완료</button>
			                    	</div>                            		
	                            </div>                                
		                                               				...
		                                               				if(result == "null"){
		                                               					...
		                                               					$.ajax({		                                               						
		                                               						...
		                                               						if(resp.result == true){
		                                               							...
		                                               							location.href="${pageContext.request.contextPath}/report/endList?page="+resp.page;		                                               							
		                                               						}else{
