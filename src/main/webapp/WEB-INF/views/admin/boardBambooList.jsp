		                                                    ...
		                                                    <td><i class="ti-trash" id="delProc${dto.seq }"></i></td>
		                                               		...
		                                               		<script>
		                                               			$("#delProc${dto.seq}").on("click", function(){
		                                               				...
		                                               				if(result){
		                                               					location.href = "${pageContext.request.contextPath}/adBoard/delBamboo?page=${page}&seq=${dto.seq}";
		                                               				}                                              				                                             				
		                                               			})
		                                               			...
		                                               			$(".toDetail${dto.seq}").on("click",function(){
		                                               				location.href = "${pageContext.request.contextPath}/adBoard/detailViewBamboo?page=${page}&seq=${dto.seq}";
		                                               			})
		                                               		</script>
		                                            	</c:forEach>                                              		
                                            		</c:otherwise>
