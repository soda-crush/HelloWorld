...
if("${result}" > 0){
	alert("삭제 완료");
	location.href = "${pageContext.request.contextPath }/admin/noticeList?page=${page}";
}else{
	alert("삭제 실패. 다시 시도해주세요");
	location.href = "${pageContext.request.contextPath }/admin/noticeDetailView?page=${page}&seq=${seq}";
}
</script>
