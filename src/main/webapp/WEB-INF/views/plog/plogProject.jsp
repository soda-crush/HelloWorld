 		...
 		<div id=baseBackgroundColor>
            ...
            <div class="container">
	            ...
	            <ul class="nav nav-tabs d-none d-sm-block">
	                ...
	                <li class="nav-item">
	                    <a class="nav-link active" href="${pageContext.request.contextPath}/Plog/toPlogProject.do">내 팀 프로젝트</a>
	                </li>
	                <li class="nav-item">
	            ...
	            <ul class="nav nav-tabs d-sm-none">
	                ...
	                <li class="nav-item">
	                    <a class="nav-link active"href="${pageContext.request.contextPath}/Plog/toPlogProject.do" style="padding:7px;">내 팀 프로젝트</a>
	                </li>
	                <li class="nav-item">
