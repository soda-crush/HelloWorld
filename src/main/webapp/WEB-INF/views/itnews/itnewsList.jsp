...
<body>
	<jsp:include page="/WEB-INF/views/standard/header.jsp"/>
 		...
 		<div id=baseBackgroundColor>
			...
			<div class=row>
				<div class="d-md-none">
					<div style="font-size: 60px; font-weight: 100;"><h1 class="fontBold cursorPointerr" onclick='location.href="${pageContext.request.contextPath}/itnews/itnewsList"'>IT News</h1></div>
